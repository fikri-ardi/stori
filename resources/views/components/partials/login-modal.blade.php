<div 
x-show="loginModal"
class="fixed flex top-0 left-0 w-full h-full z-[999] bg-black/70">
    <div 
    x-show="loginModal"
    x-transition
    @click.away="loginModal = false"
    class="h-[40rem] w-[32rem] m-auto rounded-3xl backdrop-blur-md bg-black/90 text-gray-200 p-20 pt-30">
