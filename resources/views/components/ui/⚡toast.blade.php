...
class="z-[999] relative top-full left-0 w-full flex justify-center">
    ...
    x-ref="toast"
    style="z-index: 9999;"
        class="fixed opacity-0 bg-black/50 text-gray-300 rounded-full backdrop-blur-lg shadow-lg py-3 px-4 flex items-center justify-center space-x-32 transition-all ease-in-out">
