        ...
        <div class="border-b border-white/10 px-5 py-5 sm:px-6">
            <div class="flex items-center justify-between gap-4">
                <div>
                    ...
                    <h1 class="mt-2 text-2xl font-semibold tracking-normal text-white">Create account</h1>
                </div>
            </div>
            ...
            <form method="POST" wire:submit="register" class="space-y-5">
                <div class="space-y-2">
                    ...
                    <div class="group flex h-12 items-center gap-3 rounded-2xl border border-white/10 bg-neutral-950/45 px-4 text-gray-300 shadow-[inset_0_1px_0_rgba(255,255,255,0.08)] transition focus-within:border-teal-200/50 focus-within:bg-neutral-950/65 focus-within:ring-2 focus-within:ring-teal-200/10">
                        <i class="ph-light ph-user-circle shrink-0 text-xl text-gray-500 transition group-focus-within:text-teal-200"></i>
                        <input
                            id="name"
                            wire:model="name"
                            type="text"
                ...
                <div class="space-y-2">
                    ...
                    <div class="group flex h-12 items-center gap-3 rounded-2xl border border-white/10 bg-neutral-950/45 px-4 text-gray-300 shadow-[inset_0_1px_0_rgba(255,255,255,0.08)] transition focus-within:border-teal-200/50 focus-within:bg-neutral-950/65 focus-within:ring-2 focus-within:ring-teal-200/10">
                        <i class="ph-light ph-shield-check shrink-0 text-xl text-gray-500 transition group-focus-within:text-teal-200"></i>
                        <input
                ...
                >
                    ...
                    <i wire:loading.remove wire:target="register" class="ph-light ph-arrow-right text-xl transition group-hover:translate-x-0.5"></i>
                    <i wire:loading wire:target="register" class="ph-light ph-spinner-gap text-xl animate-spin"></i>
                </button>
            </form>

            <div class="mt-5 text-center text-sm text-gray-400">
                <span>Udah punya akun?</span>
                <a class="font-medium text-white underline-offset-4 transition hover:text-teal-100 hover:underline" href="{{ route('login') }}" wire:navigate>
                    Log in
                </a>
            </div>
        </div>
